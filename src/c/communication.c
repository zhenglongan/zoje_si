	...
	{	
		...
		{    	
			...
			case QUERY:  
				...
				temp = pat_point - (PATTERN_DATA *)(pat_buf);//trans_x.word;
				send_command[12] = (UINT8)(temp>>8);
				send_command[13] = (UINT8)temp;	
				
				temp = trans_y.word;
				send_command[14] = pat_point->func;
				send_command[15] = pat_point->xstep;				
				temp = trans_z.word;
				send_command[16] = pat_point->ystep;
				send_command[17] = 0x55;	
				
				temp = recieve_x.word;
				send_command[18] = 0xaa;//(UINT8)(temp>>8);
